...
class App:
    def __init__(self, master):
        ...
        self.left_frame = tk.Frame(master, bg='#040720')  # Set left frame background
        self.left_frame.pack(side=tk.LEFT, padx=10, pady=10)
        
        self.right_frame = tk.Frame(master, bg='#040720')  # Set right frame background
        self.right_frame.pack(side=tk.RIGHT, padx=10, pady=10)

        # File selection button
        self.select_button = tk.Button(self.left_frame, text="Select File", command=self.select_file, bg='#040720', fg='white')
        self.select_button.pack()

        # Display selected file name
        self.file_name_label = tk.Label(self.left_frame, text="Selected file:", bg='#040720', fg='white')
        ...
        # Font size input
        self.font_size_label = tk.Label(self.left_frame, text="Font Size (12-22):", bg='#040720', fg='white')
        self.font_size_label.pack()
        self.font_size_entry = tk.Entry(self.left_frame, bg='#040720', fg='white')  # Change entry box background and text color
        self.font_size_entry.pack()

        # Password entry
        self.password_label = tk.Label(self.left_frame, text="Password:", bg='#040720', fg='white')
        self.password_label.pack()
        self.password_entry = tk.Entry(self.left_frame, show="*", bg='#040720', fg='white')  # Change entry box background and text color
        self.password_entry.pack()

        # Extract text button
        self.extract_button = tk.Button(self.left_frame, text="Extract Text", command=self.extract_text, bg='#040720', fg='white')
        ...
        # Change GUI background color to #040720
        master.configure(bg='#040720')
