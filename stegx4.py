...
class App:
    ...
    def extract_text(self):
        ...
        output_file = f"{os.path.splitext(self.selected_file)[0]}.txt"  # Output .txt file

        # Run stegosuite to extract the text into the output file
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                if os.path.exists(output_file):
                    ...
                    # Get font size from the user input
                    try:
                    ...
                    # Display the extracted text in the text display area
                    ...
                    messagebox.showerror("Error", "No output file was found.")
            else:
